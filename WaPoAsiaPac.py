...
base_url = 'https://www.washingtonpost.com/world/asia-pacific/?utm_term=.f876f85b28ce'
link_excel_name = 'WaPoAPAC_Links.xlsx'
data_excel_name = 'WaPoAPAC_Data.xlsx'
...
while x < 10:
    try:
        ...
        load_more_button = driver.find_element_by_class_name('button')
