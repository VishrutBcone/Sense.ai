...
base_url = 'http://www.kitv.com/category/305983/island-news'
link_excel_name = 'KITVLinks.xlsx'
data_excel_name = 'KITVData.xlsx'
...
page = driver.page_source.encode('utf-8')
soup = BeautifulSoup(page, features='lxml')
articles = soup.find_all('div', {'class': 'CardList-item-content'})
for article in articles:
    anchor = article.find('a')
    link = anchor['href']
    head = article.find('div', {'class': 'CardList-item-title'})
    headline = head.text
