...
base_url = 'http://www.mauinews.com/news/hawaii-news-apwire/?page='
link_excel_name = 'TMNLinks.xlsx'
data_excel_name = 'TMNData.xlsx'
...
#     page = driver.page_source.encode('utf-8')
#     soup = BeautifulSoup(page, features='lxml')
#     section = soup.find_all('section', {'id': 'full_category'})
#     articles = section[0].find_all('article')
#     for article in articles:
#         link = 'http://www.mauinews.com'+article.find('a')['href']
